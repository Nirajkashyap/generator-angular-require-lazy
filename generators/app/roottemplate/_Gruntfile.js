...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concurrent: {
      server: [<% if (csscode.compass) { %>
        'compass:server'<% } else { %>
        'copy:styles'<% } %>
      ],
      test: [<% if (csscode.compass) { %>
        'compass'<% } else { %>
        'copy:styles'<% } %>
      ],
      dist: [<% if (csscode.compass) { %>
        'compass:dist',<% } else { %>
        'copy:styles',<% } %>
        'imagemin',
        'svgmin'
    ...
    copy: {
      dist: {
        files: [{
          ...
          src: ['generated/*']
        }<% if (csscode.bootstrap) { %>, {
          expand: true,
          cwd: '<% if (!csscode.compassBootstrap) {
              %>bower_components/bootstrap/dist<%
            } else {
              %>.<%
            } %>',
          src: '<% if (csscode.compassBootstrap) {
